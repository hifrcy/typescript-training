describe('Object Types', () => {
	...
	describe('typeof operator', () => {
		...
		it('defines complex types not that precisely', () => {
			...
			expect(typeof person.first).toEqual("number" );
			expect(typeof person['last']).toEqual( "number" );
			expect(typeof person['last'].length).toEqual( "string" );
		});
